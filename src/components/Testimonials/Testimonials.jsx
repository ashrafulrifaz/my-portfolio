            ...
            <div className="grid grid-cols-2 gap-10 mt-12">
                <div>
                    <div className='border border-[#d2d2d2] rounded-2xl p-5'>
                        ...
                        <div className='flex items-center gap-3'>
                            <Image src={'/assets/reviews/user-1.png'} alt='user image' width={50} height={50} className='rounded-full' />
                            <div>
                    ...
                    <div className='border border-[#d2d2d2] rounded-2xl p-5 mt-10'>
                        ...
                        <hr className='text-[#d2d2d2]/70 mt-6 mb-5' />
                        <div className='flex items-center gap-3'>
                            <Image src={'/assets/reviews/user-3.png'} alt='user image' width={50} height={50} className='rounded-full' />
                            <div>
                ...
                <div>
                    <div className='border border-[#d2d2d2] rounded-2xl p-5 mt-20'>
                        ...
                        <hr className='text-[#d2d2d2]/70 mt-6 mb-5' />
                        <div className='flex items-center gap-3'>
                            <Image src={'/assets/reviews/user-2.png'} alt='user image' width={50} height={50} className='rounded-full' />
                            <div>
                    ...
                    <div className='border border-[#d2d2d2] rounded-2xl p-5 mt-10'>
                        ...
                        <hr className='text-[#d2d2d2]/70 mt-6 mb-5' />
                        <div className='flex items-center gap-3'>
                            <Image src={'/assets/reviews/user-4.png'} alt='user image' width={50} height={50} className='rounded-full' />
                            <div>
