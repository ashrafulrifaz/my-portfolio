        ...
        <FadeOnHover className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:h-[90vh] py-16 lg:py-0 lg:mt-20">
            <div className="flex flex-col justify-center h-full">
                ...
                <div className="flex items-center gap-5 mt-10">
                    ...
                    <Link href={'https://www.linkedin.com/in/imashrafulislam/'} target="_blank" aria-label="LinkedIn profile">
                        <svg
                    ...
                    <Link href={'https://github.com/ashrafulrifaz'} target="_blank" aria-label="GitHub profile">
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="22"
                    ...
                    <Link href={'mailto:devrifaz@email.com'} target="_blank" aria-label="Email me">
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="22"
            ...
            <div className="flex flex-col justify-center items-center lg:items-end mt-6 lg:mt-0">
                <PixelImage
                src="https://res.cloudinary.com/db30o33kz/image/upload/w_400,q_auto,f_auto/v1785510220/ChatGPT_Image_Jul_30_2026_at_05_06_04_PM_oazgxm.png"
