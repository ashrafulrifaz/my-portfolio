        ...
        <div className='py-20'>
            ...
            <div className='mt-14 border-2 border-[#d2d2d2] bg-[#f4f4f4] p-2 rounded-2xl'>
                <div className='border border-[#d2d2d2] bg-[#fffffc] rounded-xl p-5 pb-0'>
                    ...
                    <Image src={'https://res.cloudinary.com/db30o33kz/image/upload/v1785517392/project-1_khqiz3.png'} alt='project 1' width={200} height={150} className='w-[93%] h-auto mt-7 rounded-t-3xl mx-auto border-[5px] border-b-0 border-[#E4E1E1]' />
                </div>
            </div>
            <div className='mt-14 border-2 border-[#d2d2d2] bg-[#f4f4f4] p-2 rounded-2xl'>
                <div className='border border-[#d2d2d2] bg-[#fffffc] rounded-xl p-5 pb-0'>
                    ...
                    <p className='text-[#7E7067] font-regular mt-2'>A modern, fully responsive digital agency website</p>
                    <Image src={'https://res.cloudinary.com/db30o33kz/image/upload/v1785517402/project-2_dsz0ck.png'} alt='project 1' width={200} height={150} className='w-[93%] h-auto mt-7 rounded-t-3xl mx-auto border-[5px] border-b-0 border-[#E4E1E1]' />
                </div>
            </div>
            <div className='mt-14 border-2 border-[#d2d2d2] bg-[#f4f4f4] p-2 rounded-2xl'>
                <div className='border border-[#d2d2d2] bg-[#fffffc] rounded-xl p-5 pb-0'>
                    ...
                    <Image src={'https://res.cloudinary.com/db30o33kz/image/upload/v1785517395/project-3_n8oyny.png'} alt='project 1' width={200} height={150} className='w-[93%] h-auto mt-7 rounded-t-3xl mx-auto border-[5px] border-b-0 border-[#E4E1E1]' />
                </div>
            </div>
            <div className='flex items-center justify-center mt-12'>
                <Link href={'/projects'} className='capitalize font-medium border border-[#D2D2D2] bg-[#F9F8F6] rounded-full pl-3.5 pr-3 py-1.5 flex gap-2 text-[#251D18] items-center shadow-sm cursor-pointer'>
                    <span>See more</span>
