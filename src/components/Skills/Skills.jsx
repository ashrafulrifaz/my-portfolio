        ...
        <div className='h-[90vh] lg:h-[70vh] flex flex-col justify-center items-center relative'>
            ...
            <div>
                <motion.div
                    ...
                    className='rounded-2xl overflow-hidden w-14 h-14 bg-black absolute top-[60%] lg:top-1/2 right-[30%] lg:right-[20%] cursor-pointer'
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className='rounded-2xl overflow-hidden w-14 h-14 bg-black absolute bottom-10 lg:bottom-20 left-1/4 lg:left-1/5 flex items-center justify-center cursor-pointer'
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className='rounded-2xl overflow-hidden w-14 h-14 bg-[#F9F8F6] absolute top-10 right-[30%] border border-[#d2d2d2] flex items-center justify-center cursor-pointer'
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className='rounded-2xl overflow-hidden w-14 h-14 bg-black flex items-center justify-center absolute top-5 lg:top-10 left-5 cursor-pointer'
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className='rounded-2xl overflow-hidden w-14 h-14 bg-black flex items-center justify-center absolute bottom-5 lg:bottom-10 right-7 lg:right-10 cursor-pointer'
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className="rounded-2xl overflow-hidden w-14 h-14 bg-[#F9F8F6] flex items-center justify-center border border-[#d2d2d2] absolute top-1/4 right-5 lg:right-15 cursor-pointer"
                >
                ...
                <motion.div
                    ...
                    whileHover={hoverEffect}
                    className="rounded-2xl overflow-hidden w-14 h-14 bg-[#F9F8F6] flex items-center justify-center border border-[#d2d2d2] absolute top-[59%] lg:top-1/2 left-8 lg:left-16 cursor-pointer"
                >
